        ...
        @foreach($games as $game)
            ...
            <tr>
                ...
                <td class="align-middle border-left">
                    <input type="radio" name="game_{{$game->number}}" value="{{$game->home_team}}" @if(old("game_{$game->number}") == $game->home_team || $game->picked == $game->home_team) checked @endif>
                ...
                <td class="align-middle border-left">
                    <input type="radio" name="game_{{$game->number}}" value="{{$game->away_team}}" @if(old("game_{$game->number}") == $game->away_team || $game->picked == $game->away_team) checked @endif>
